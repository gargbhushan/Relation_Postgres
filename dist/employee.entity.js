...
__decorate([
    (0, typeorm_1.OneToOne)(() => contact_info_entity_1.ContactInfo, (contactInfo) => contactInfo.employee),
...
__decorate([
    (0, typeorm_1.ManyToMany)(() => meeting_entity_1.Meeting, (meeting) => meeting.attendees),
